...
export function TableMembers(props: TableMembersProps): JSX.Element {
  ...
  //nouvelles variables pour la gestions d'affichage des statistiques
  ...
  const [dateRange, setDateRange] = useState<number>(3); // P

  // Fonction pour calculer les statistiques d'inscription par période de N mois
