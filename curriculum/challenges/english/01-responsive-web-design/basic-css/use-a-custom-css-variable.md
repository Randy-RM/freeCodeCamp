...
Cela changera le fond de l'élément que vous ciblez en gris, car c'est la valeur de la variable `--penguin-skin`. Notez que les styles ne seront appliqués que si les noms des variables correspondent exactement.
